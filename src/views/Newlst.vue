  ...
  <div class="view-container" view-id="44576">
    ...
    <div style="height: 70px"></div>
      ...
      <div class="article el-tabs--border-card">
        <div class="mod18"> <span id="prev" class="btn prev"></span> <span id="next" class="btn next"></span> <span id="prevTop" class="btn prev" style="display: none;"></span> <span id="nextTop" style="display: none;" class="btn next"></span>
              <div id="picBox" class="picBox">
                  <ul class="cf" ref="picBoxULref">
                      <li  v-for="(item, index) in newlst" v-if="index < 4"  ref="picBoxLIref">
    ...
    <div class="other-info">  <div class="hot-match">
      ...
      <div class="relative-news" style="margin-top: 20px;"><div class="head"><div class="red-line"></div><div class="title" style="width:160px">资讯热点 &nbsp;&nbsp;&nbsp;</div>
        <div class="space-holder"></div>

      </div>
        <div class="list" style="margin: 20px;cursor:pointer">
          <div v-for="item in collect" :key="item" style="cursor:pointer"  @click="$router.push({name: 'New', params: {key: 'newid', value: item.id }})">
