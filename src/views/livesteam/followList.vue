    ...
    <div>
        ...
        >
            ...
            <i>足球</i>
                ...
                <div class="ellipsebottom" style="height: 55px;display: flex;ustify-content: center;align-items: center;">
            <span>
              <img class="avatar" src="https://sta.cranemarsh.com/file/head/20200901/2d1e8cb01a1bcef7e0c49ffadcdcf40d"/>
            </span>
                    <div class="userabout" style="padding-top: 10px;padding-left: 10px;">
                        <div class="itemtitle"><h4 class="ellipsis">{{ item.title }}</h4></div>
                        <div class="userbottome">
                            <div class="username" style="float: left;font-size: 12px">{{ item.user_nicename }}</div>
                            <div class="frier" style="float: right"><span class="num">{{ item.online }}</span></div>
                        </div>
                    </div>
                </div>
            </li>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                sendlist: [],
                zhibo: [{pull:111,thumb:222,isrecommend:1,title:'俄罗斯乙级联赛 克拉斯诺...',user_nicename:44444,online:5555},
                    {pull:111,thumb:222,isrecommend:1,title:'俄罗斯乙级联赛 克拉斯诺...',user_nicename:44444,online:5555},
                    {pull:111,thumb:222,isrecommend:1,title:'俄罗斯乙级联赛 克拉斯诺...',user_nicename:44444,online:5555},
                    {pull:111,thumb:222,isrecommend:1,title:'俄罗斯乙级联赛 克拉斯诺...',user_nicename:44444,online:5555},
                    {pull:111,thumb:222,isrecommend:1,title:'俄罗斯乙级联赛 克拉斯诺...',user_nicename:44444,online:5555},
                    {pull:111,thumb:222,isrecommend:1,title:'俄罗斯乙级联赛 克拉斯诺...',user_nicename:44444,online:5555},
