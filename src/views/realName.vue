...
<el-dialog
    ...
    <div id="myProfile">
        <el-form :model="registerForm" :rules="registerRule" ref="registerForm" style="width: 820px; margin: 30px auto">
            <el-form-item prop="name">
                <a class="xing">*</a>真实姓名:
                <el-input v-model="registerForm.name"  placeholder="请输入真实姓名" style="width: 180px;margin-left: 22px;"></el-input>
            </el-form-item>
            <el-form-item prop="user_card">
                <a class="xing">*</a>身份证号码:
                <el-input v-model="registerForm.user_card"  placeholder="请输入身份证号码" style="width: 330px"></el-input>
            </el-form-item>
            ...
            <el-form-item>
                <div style="display: flex; justify-content: space-between">
                    ...
                    <el-button type="primary" style="background: linear-gradient(90deg, #eccbab, #dbb16f 100%); border-color: #f8c21b;width:108px;height:40px;font-size:16px;font-weight: 400;    color: #693D12;
;margin-left: 366px;" @click="registerSub('registerForm')">
                        确定绑定
                    </el-button>
                </div>
            </el-form-item>
...
<script>
    import {Getcode,UserApplyAnchor} from '@/api'
