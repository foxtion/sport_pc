        ...
        <el-popover width="400" trigger="hover">
          ...
          >
            ...
            >
              ...
              ></el-avatar>
              <p
                style="font-size: 20px; letter-spacing: 1px；font-size: 18px;
              ...
              <el-tag
                ...
                effect="dark"
                size="small"
                style="position: absolute; left: 5px; top: 150px"
                >Lv.{{ info.level }}</el-tag
              >
              <div
              ...
              <el-tag
                ...
                effect="dark"
                size="small"
                style="position: absolute; right: 5px; top: 150px"
                >Lv.{{ info.level }}</el-tag
              >
            </div>
    ...
    >
      <el-tooltip class="item" effect="light" placement="left">
        ...
        <img
          ...
          ref="recordque"
          @mouseover="changeimgw(1)"
          @mouseleave="changeimgw(2)"
          src="../assets/img/fankuian.png"
        />
      </el-tooltip>
      <br /><br />

      <el-tooltip class="item" effect="light" placement="left">
        <div slot="content" style="color: #1e90ff">
          <img
            width="60px"
            src="https://ss2.bdstatic.com/70cFvnSh_Q1YnxGkpoWK1HF6hhy/it/u=1359915540,789195830&fm=26&gp=0.jpg"
          /><br />一度体育app
        </div>
        <img
          ref="xiazaiapp"
          @mouseover="changeimgy(1)"
          @mouseleave="changeimgy(2)"
          style="border-radius: 50%"
          src="../assets/img/downapp.png"
        />
      </el-tooltip>
      <br />
...
export default {
  ...
  methods: {
    ...
    changeimgw(type) {
      if (type == 1) {
        this.$refs.recordque.src =
          "https://soket.daoyunxiang.com/fankuian2.png";
      } else {
...
#nav {
  ...
  background: linear-gradient(
    ...
    rgba(251, 252, 255, 1) 53%,
    rgba(241, 246, 255, 1) 91%,
